...
define(["vendor/backbone", "./Templates", "./SlidePreviewPanel", "./OperatingTable", "common/EventEmitter", "./button_bar/ButtonBarView", "ui/widgets/PictureGrabber", "vendor/keymaster"], function(Backbone, Templates, SlidePreviewPanel, OperatingTable, EventEmitter, ButtonBarView, PictureGrabber, Keymaster) {
