...
define(["vendor/Handlebars"], function (Handlebars) {
    return {
        ...
        "PictureGrabber": Handlebars.template(function (Handlebars, depth0, helpers, partials, data) {
            helpers = helpers || Handlebars.helpers;
            var foundHelper, self = this;
        ...
        "ItemGrabber": Handlebars.template(function (Handlebars, depth0, helpers, partials, data) {
            ...
            buffer += "<div class=\"modal-header\">	<button class=\"close\" data-dismiss=\"modal\">×</button>	<h3>";
            ...
            buffer += escapeExpression(stack1) + "</h3></div><div class=\"modal-body\">	<div class=\"alert alert-error disp-none\">  		<button class=\"close\" data-dismiss=\"alert\">×</button>  		The image URL you entered appears to be incorrect	</div>	<h4>URL:</h4><input type=\"text\" name=\"itemUrl\"></input>	<h4>Preview:</h4>	<ul class=\"thumbnails\">		<li class=\"span4\">			<div class=\"thumbnail\">				<";
            foundHelper = helpers.tag;
            stack1 = foundHelper || depth0.tag;
            if (typeof stack1 === functionType) {
                stack1 = stack1.call(depth0, { hash: {} });
            } else if (stack1 === undef) {
                stack1 = helperMissing.call(depth0, "tag", { hash: {} });
            }
            ...
            buffer += escapeExpression(stack1) + ">			</div>		</li>	</ul></div><div class=\"modal-footer\">	<a href=\"#\" class=\"btn btn-primary ok btn-inverse\">";
            foundHelper = helpers.title;
            stack1 = foundHelper || depth0.title;
            if (typeof stack1 === functionType) {
                stack1 = stack1.call(depth0, { hash: {} });
        ...
        "SaveAsDialog1": Handlebars.template(
            function (Handlebars, depth0, helpers, partials, data) {
                ...
                buffer += "<div class=\"modal-header\">	<button class=\"close\" data-dismiss=\"modal\">×</button>	<h3>Save as...</h3></div><div class=\"modal-body\">	 	<h4>Name</h4>			<input type=\"text\" id=\"name\"></input><h4>Description</h4>			<input type=\"text\" id=\"description\"></input><h4>Tags</h4>			<input type=\"text\" id=\"tags\"></input>			<ul class=\"nav nav-list\">				";
                foundHelper = helpers.fileNames;
                stack1 = foundHelper || depth0.fileNames;
                stack2 = helpers.each;
                tmp1 = self.program(1, program1, data);
                ...
                buffer += "</div><div class=\"modal-footer\">	<a href=\"#\" class=\"btn btn-inverse ok\">OK</a>	<a href=\"#\" class=\"btn\" data-dismiss=\"modal\">Cancel</a></div>";
                return buffer;
            }),
